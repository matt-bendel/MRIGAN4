...
def get_mask(resolution, return_mask=False, R=4, p_m=False, args=None, mask_type=2, varnet=False):
    ...
    if mask_type == 1:
        ...
        # HIGH DIM R=4 GRO
        if R == 4:
            # a = [1, 11, 21, 30, 39, 47, 56, 64, 71, 78, 85, 92, 98, 105, 111, 116, 122, 127, 132, 137, 142, 146, 151,
            #      155, 159, 163, 167, 171, 175, 176, 177, 178, 179, 180, 181, 182, 183, 184, 185, 186, 187, 188, 189,
            #      190, 191, 192, 193, 194, 195, 196, 197, 198, 199, 200, 201, 202, 203, 204, 205, 206, 207, 208, 211,
            #      215, 219, 223, 227, 231, 235, 240, 244, 249, 254, 259, 264, 270, 275, 281, 288, 294, 301, 308, 315,
            #      322, 330, 339, 347, 356, 365, 375]
