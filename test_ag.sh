...
python test.py --mri --rcgan --exp-name neurips/rcgan_agnostic_bline_no_dc --nodc --mask-type 1 --R 2 >> "2.txt"

echo "R=4 Models - GRO" > "4.txt"
echo "Blind No DC" >> "4.txt"
python test.py --mri --rcgan --exp-name neurips/rcgan_agnostic_bline_no_dc --nodc --mask-type 1 --R 4 >> "4.txt"

echo "R=6 Models - GRO" > "6.txt"
echo "Blind No DC" >> "6.txt"
python test.py --mri --rcgan --exp-name neurips/rcgan_agnostic_bline_no_dc --nodc --mask-type 1 --R 6 >> "6.txt"
...
python test.py --mri --rcgan --exp-name neurips/rcgan_agnostic_bline_no_dc --nodc --mask-type 1 --R 8 >> "8.txt"
