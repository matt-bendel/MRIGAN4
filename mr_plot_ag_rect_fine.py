        ...
        for i, data in enumerate(test_loader):
            ...
            for j in range(y.size(0)):
                ...
                if False:#j == 0:
                    ...
                    zoom_startx = np.random.randint(80, 130)
                    zoom_starty1 = np.random.randint(30, 80)
                    zoom_starty2 = np.random.randint(200, 280)
                    zoom_lengthx = 160
                    zoom_lengthy = 80
                ...
                ax = plt.subplot(gs[2:4, count+2:count+4])
                ...
                ax = plt.subplot(gs[4:6, count+2:count+4])
                ...
                for method in keys:
                    ...
                    ax = plt.subplot(gs[7, count:count+2])
                ...
                ax = plt.subplot(gs[6, count+2:count+4])
                ...
                ax = plt.subplot(gs[7, count+2:count+4])
