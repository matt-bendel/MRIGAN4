...
class Generator(BaseNetwork):
    def __init__(
            self,
    resolution, num_realizations):                                          # Arguments for sub-networks (mapping and synthesis).
        super().__init__()
        self.G_mapping = G_mapping()
        self.G_synthesis = G_synthesis_co_mod_gan(resolution, num_realizations)
